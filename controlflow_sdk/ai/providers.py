...
raw ``rule_spec`` dict that the validation gate in :mod:`controlflow_sdk.ai.draft`
...
class Provider(Protocol):
    ...
    The returned dict is never trusted — :func:`controlflow_sdk.ai.draft.draft_and_validate`
...
class _AnthropicProvider:
    def draft_rule_spec(
        ...
        from controlflow_sdk.ai.draft import (
