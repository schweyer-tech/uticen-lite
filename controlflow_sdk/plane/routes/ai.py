...
def register(
    ...
    async def draft_rule(request: Request) -> HTMLResponse:
        ...
        try:
            ...
            from controlflow_sdk.ai.draft import draft_and_validate
            ...
            try:
                ...
                from controlflow_sdk.ai.draft import DraftError
            ...
            from controlflow_sdk.plane.routes.controls import _primary_columns
