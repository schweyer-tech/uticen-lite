...
``assemble_bundle`` produces the versioned import contract that the Uticen
...
from uticen_lite.schema import SCHEMA_VERSION
...
def _build_control_block(
    ...
    :func:`~uticen_lite.rules.resolve.resolve_test_code` (inline → rule →
...
def assemble_bundle(
    ...
    *,
    ...
    Args:
        project:          A fully loaded :class:`~uticen_lite.project.Project`.
