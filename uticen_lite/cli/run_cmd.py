"""``uticen-lite run`` subcommand — execute controls via the store and write workpaper outputs.

Usage
-----
    uticen-lite run [dir] [--control <id>] [--at <iso8601>]
...
def run_cmd(args: argparse.Namespace) -> int:
    """Handle ``uticen-lite run [dir] [--control <id>] [--at <iso8601>]``."""
